...
всего на <%=since%>: <span style="color:blue;"><%=amount1%></span>т 
на <%=till%>: <span style="color:red;"><%=amount2%></span>т. , <span style="color:black;"><%=sks%></span> грн
Разница: <span style="color:#7F6084;"><%=amount2-amount1%></span> т.
Поступило с <%=since%> по <%=till%>:<span style="color:#86B402;"><%=inp%></span>т.
</body>
<script type="text/javascript">
